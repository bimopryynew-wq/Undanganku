...
export class AppComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  whatsappLink = computed(() => `https://api.whatsapp.com/send?phone=6285133780410&text=${encodeURIComponent(this.whatsappMessage())}`);
  ...
  songRequestWhatsappLink = computed(() => `https://api.whatsapp.com/send?phone=6285133780410&text=${encodeURIComponent(this.songRequestWhatsappMessage())}`);
  ...
  guestbookWhatsappLink = computed(() => `https://api.whatsapp.com/send?phone=6285133780410&text=${encodeURIComponent(this.guestbookWhatsappMessage())}`);
  ...
  bankRequestWhatsappLink = computed(() => {
    ...
    return `https://api.whatsapp.com/send?phone=6285133780410&text=${encodeURIComponent(message)}`;
  });
